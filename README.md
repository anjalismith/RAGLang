...
The match method checks if the current token matches the expected type and optionally, an expected value. If it matches, it advances to the next token. If it doesn’t match, it raises a SyntaxError.
